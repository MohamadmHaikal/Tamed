                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    @if(count($translations))
                                                        ...
                                                        <table>
                                                            ...
                                                            <thead>
                                                                <tr>
                                                                    <th class="w-1/5 uppercase font-thin">{{ __('backend.Group') }}</th>
                                                                    <th class="w-1/5 uppercase font-thin">{{ __('backend.key') }}</th>
                                                                    <th class="uppercase font-thin">{{ __('backend.ar') }}</th>
                                                                    <th class="uppercase font-thin">{{  __('backend.'.$language) }}</th>
                                                                </tr>
                                                            </thead>
                    ...
                    <form action="{{ route('languages.translations.store', 'ar') }}" method="POST">
                        ...
                        <fieldset>
                            ...
                            <div class="panel-body p-4">
                                ...
                                @include('translation::forms.text', ['field' => 'group', 'label' => __('backend.GROUP (OPTIONAL)')])
                                
                                @include('translation::forms.text', ['field' => 'key', 'label' => __('backend.key')])
            
                                @include('translation::forms.text', ['field' => 'value', 'label' => __('backend.value')])
