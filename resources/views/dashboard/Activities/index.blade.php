        ...
        <header class="header navbar navbar-expand-sm">
            ...
            <a href="{{ route('activites.create') }}">
                <button type="button" class="btn btn-success font-18 add rounded bs-tooltip lol" data-placement="bottom"
                    title="{{ __('add new  activity') }}"><i class="las la-plus-circle"></i></button>
                                    ...
                                    <div class="dropdown custom-dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink1"
                                            ...
                                            <a class="dropdown-item"
                                                href="{{ route('activites.show', [$activitie->id]) }}">{{ __('backend.Show') }}</a>
                                            <a class="dropdown-item"
                                                href="{{ route('activites.edit', [$activitie->id]) }}">{{ __('backend.Edit') }}</a>
                                            <a class="dropdown-item bottom-right"
                                                href="{{ route('activites.delete', [$activitie->id]) }}"
