    ...
    <div class="layout-px-spacing">
        <div class="row layout-top-spacing">
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mb-4">
                <div class="widget overflow-hidden text-center  mb-4">
                    <div class="confetti">
                ...
                <div class="widget overflow-hidden">
                    <div class="d-flex align-center justify-content-between">
                        <div class="d-flex align-center">
                            <img src="{{ url('assets/img/profile-1.jpg') }}" class="avatar-xs rounded-circle">
                            <div class="ml-3">
                                <h6 class="mb-1 font-14 strong">Jonathan Smith</h6>
                                <p class="mb-0 font-12">Product Designer</p>
                            </div>
                        </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mb-4">
                <div class="widget overflow-hidden mb-4">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            <h5>Sales Meeting</h5>
                            <p class="text-muted font-11 mt-1 mb-0">Start time 11th August 2021</p>
                            <div class="mt-1">
                                <span class="badge font-10 badge-info">Skype</span>
                            </div>
                        </div>
                        <div class="text-right">
                            <h6 class="font-25 strong mb-0 text-success">175</h6>
                            <p class="mb-0 text-success">Joined</p>
                        </div>
                    </div>
                    <hr class="my-3">
                    <h6 class="font-12 mb-3">Speaker</h6>
                    <div class="avatar-group">
                        ...
                        <span class="text-primary font-11">+3 More</span>
                    </div>
                </div>
                <div class="widget overflow-hidden">
                    <p class="font-12 text-success-teal strong">Report is ready!</p>
                    <h6 class="mb-4 font-17 strong">Download last 180 days of spending report</h6>
                    <a class="btn btn-sm bg-gradient-primary text-white">Download</a>
                    <i class="las la-file-csv ab-rb text-success-teal"></i>
                </div>
            </div>
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mb-4">
                <div class="widget overflow-hidden p-0">
                    <img src="{{ url('assets/img/food-image.jpg') }}" width="100%"/>
                    <div class="p-4">
                        <h6 class="mb-3 font-17 strong">August Food Coupon is here!</h6>
                        <p class="font-12 text-muted mb-3">Amount will be credited to your card after 24 hours of redemption</p>
                        <a class="btn btn-sm btn-primary text-white">Redeem</a>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 layout-spacing">
                    ...
                    <div class="widget-content">
                        <div class="sales-summary-content d-flex mb-3 mt-4">
                            <div class="sales-summary-icon mr-3">
                                <i class="las la-chart-bar sales-secondary-icon"></i>
                            </div>
                            <div class="sales-progress flex-grow-1">
                                <span class="font-12">Sales</span>
                                <span class="font-12 float-right">$8190</span>
                                <div class="progress progress-sm">
                                    <div class="progress-bar bg-gradient-secondary" role="progressbar" aria-valuenow="70" style="width:70%"></div>
                                </div>
                            </div>
                        </div>
