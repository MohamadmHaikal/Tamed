    ...
    <div class="sub-header-container">
        <header class="header navbar navbar-expand-sm">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            ...
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a
                                        href="javascript:void(0);">{{ __('backend.Project Services') }}</a>
                                </li>
            ...
            <a href="{{ route('services.create') }}">
                <button type="button" class="btn btn-success font-18 add rounded bs-tooltip lol" data-placement="bottom"
                    title="{{ __('add new  services') }}"><i class="las la-plus-circle"></i></button>
            ...
            <div class="table-responsive mb-4">
                <table id="last-page-dt" class="table table-hover" style="width:100%">
                    <thead>
                        <tr>
                            <th>{{ __('backend.id') }}</th>
                            <th>{{ __('backend.name of Service') }}</th>
                                    ...
                                    <div class="dropdown custom-dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink1"
                                            ...
                                            <a class="dropdown-item"
                                                href="{{ route('services.show', [$Service->id]) }}">{{ __('backend.Show') }}</a>
                                            <a class="dropdown-item"
                                                href="{{ route('services.edit', [$Service->id]) }}">{{ __('backend.Edit') }}</a>
