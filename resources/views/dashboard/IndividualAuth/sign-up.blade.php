        ...
        <div class="container-fluid login-three-container">
            <div class="row main-login-three">
                <div class="col-xl-7 col-lg-6 col-md-6 d-none d-md-block p-0">
                    <div class="login-bg" style=" background-image: url(../assets/img/tamed-inv.jpg);"></div>
                </div>
                ...
                <div class="col-xl-5 col-lg-6 col-md-6">
                    <div class="d-flex flex-column justify-content-between  right-area ">
                        ...
                        <div class="d-flex align-items-center justify-content-center title">
                            <h3 style="color:#027496">التسجيل في منصة تعميد أفراد</h3>
                        </div>
                        ...
                        <div class="mt-5">
                            ...
                            <div class="login-three-inputs mt-3">
                                <small>يجب ان يبدأ رقم الجوال ب 966</small>
                                <input type="text" placeholder="رقم الجوال" id="mobile">
                            ...
                            <div class="login-three-inputs mt-4">
                                <input type="password" placeholder="تأكيد كلمة المرور " id="passwordConfirm">
                            ...
                            <div class="d-flex align-items-center justify-content-center mt-4 checkButton">
                                <a class="text-white btn " id="getCodeSign"
                            ...
                            <div class="d-flex align-items-center justify-content-center mt-4 " id="underCheck">
                                <a id="newAccount" style="color:#0298a7;" href="{{ route('auth.login') }}">لديك حساب
                                    بالفعل </a>
                            </div>
                            <div class="d-flex align-items-center justify-content-center mt-4 text-center">
                                <a class="soonImg" style="color:#0298a7;" href="javascript:void(0);">
                                    ...
                                    <img class="cardlog" src="{{ asset('assets/img/soonNafaz.jpg') }}" width="75%">
                                </a>
                            </div>
                        </div>
...
@push('plugin-scripts')
    ...
    {!! Html::script('assets/js/authentication/Individuals.js') !!}
